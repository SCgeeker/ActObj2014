...
2. Word decoding: Timeline of my studies <font color="green"><b>`r paste(100*(8-4)/40, "%")`</b></font>
3. Embodied cognition: Measure mental simulation <font color="green"><b>`r paste(100*(31-8)/40, "%")`</b></font>
...
```{r echo=FALSE, results='hide', message=FALSE, label="WordColor-Dataset"}
SP_RT_M <- matrix(
  AB_RT,2,4,
...
CRITIC_RT_BA <- matrix(
            ...
            dimnames = list(c("C", "I"), c("Twist","Tide", "Hard"))
)
...
CRITIC_RT_BB <- matrix(
    ...
    dimnames = list(c("C", "I"), c("Pick","Hard", "Tide"))
)
